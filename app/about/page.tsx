    ...
    <>
      ...
      {/* <main className="md:max-w-[1170px] max-w-[640px] mx-auto pt-8">
        ...
        <div className="grid md:grid-cols-[60%_auto] md:l-0">
          <div className=" md:p-6 pl-44 h-[440px]">

            <h2 className="md:text-2xl font-bold mt-14 text-xl">Sahil Yousaf</h2>
            <p className="md:text-[15px] text-[20px] text-gray-500">
          ...
          <div className="pl-44 md:p-0 md:m-0">
