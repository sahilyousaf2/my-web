    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex">
          <button className="px-6 py-2 bg-gradient-to-r from-primary to-accent text-secondary font-semibold rounded-lg hover:shadow-lg hover:shadow-primary/50 transition-all duration-300">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="pt-4 border-t border-white/10">
              <button className="w-full px-4 py-2 bg-gradient-to-r from-primary to-accent text-secondary font-semibold rounded-lg hover:shadow-lg transition-all duration-300">
                <Link href="/contact">Get Started</Link>
              </button>
            </div>
          </motion.div>
